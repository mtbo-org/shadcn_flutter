          ...
          Steps(
            children: [
              StepItem(
                ...
                content: [
                  const Text('If you don\'t have a web directory, create one.')
                      .p(),
                  const CodeBlock(
                ...
                content: [
                  ...
                  const Column(
                    ...
                    children: [
                      ...
                      Gap(8),
                      CodeBlock(
                        code: '<script src="https://cdn.jsdelivr.net/gh/sunarya-thito/shadcn_flutter@latest/web_loaders/standard.js"></script>',
                        mode: 'javascript',
                      ),
                    ],
                  ).li().p(),
