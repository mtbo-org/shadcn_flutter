...
class _MaterialExample1State extends State<MaterialExample1> {
  ...
  Widget build(BuildContext context) {
    // The Material theme, the Material ancestor, ScaffoldMessenger and the
    // Material localizations all come from the app root — this docs site
    // installs them with MaterialLayer, and your own app would normally use
    // MaterialShadcnApp, which does the same thing in one widget.
    return Scaffold(
      appBar: AppBar(
