...
Future<void> generateComponentSkills(FeatureSet featureSet) async {
  final componentsDir = Directory('packages/shadcn_flutter/lib/src/components');
  final docsDir = Directory('packages/docs/lib/pages/docs/components');
  final skillsDir = Directory('packages/shadcn_flutter/skills/shadcn-flutter/components');
  ...
  final docsPageContent =
      File('packages/docs/lib/pages/docs_page.dart').readAsStringSync();
  ...
  final skillFile = File('packages/shadcn_flutter/skills/shadcn-flutter/SKILL.md');
...
Future<void> generateIconSkills(FeatureSet featureSet) async {
  final iconDir = Directory('packages/shadcn_flutter/lib/src/icons');
  final iconOutputFolder = Directory('packages/shadcn_flutter/skills/shadcn-flutter/icons');
...
Future<void> generateColorSkills(FeatureSet featureSet) async {
  final colorsFile = File('packages/shadcn_flutter/lib/src/theme/generated_colors.dart');
  final themesFile = File('packages/shadcn_flutter/lib/src/theme/generated_themes.dart');
  final colorsGuide = File('packages/shadcn_flutter/skills/shadcn-flutter/guides/colors.md');
