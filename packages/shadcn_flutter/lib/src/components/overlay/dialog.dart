...
// Dialog overlays are presented via [DialogConfiguration] (see
// overlay_configuration.dart), which owns this presentation logic directly.
// Use `OverlayConfiguration.maybeOf(context) is DialogConfiguration` to
// check whether the current context is inside a dialog overlay, and
// `DialogConfiguration(fullScreen: true)` for a full-screen dialog.
