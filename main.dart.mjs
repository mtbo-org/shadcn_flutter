...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AI: (x0,x1) => { x0.min = x1 },
      AJ: x0 => new Blob(x0),
      AK: x0 => x0.rasterStartMilliseconds,
      ...
      FJ: x0 => x0.frameCount,
      FK: (x0,x1,x2) => new ImageData(x0,x1,x2),
      ...
      HI: a => a.pop(),
      HJ: x0 => x0.completed,
      HK: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      NK: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      ...
      SI: (x0,x1,x2) => new ShadcnAppTheme(x0,x1,x2),
      SJ: x0 => x0.status,
      ...
      TI: x0 => new ShadcnAppThemeChangedEvent(x0),
      TJ: x0 => x0.response,
      ...
      UH: x0 => x0.first(),
      UI: (x0,x1) => x0.dispatchEvent(x1),
      UJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      UK: x0 => x0.location,
      V: (constructor, args) => {
      ...
      ZH: () => globalThis.Intl,
      ZI: (x0,x1) => { x0.shadcnAppLoaded = x1 },
      ZJ: x0 => x0.abort(),
      ...
      iI: () => globalThis.document,
      iJ: x0 => x0.url,
      iK: x0 => x0.localStorage,
      j: x0 => x0.random(),
      ...
      wJ: (x0,x1) => x0.transferFromImageBitmap(x1),
      ...
      zH: x0 => x0.disabled,
      zI: x0 => x0.URL,
      zJ: x0 => x0.rasterEndMilliseconds,
